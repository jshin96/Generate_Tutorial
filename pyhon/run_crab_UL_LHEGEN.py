...
# with command line options: Configuration/GenProduction/python/tt012j_5f_Vcb_NLO_FXFX.py --fileout file:TOP-RunIISummer20UL18wmLHEGEN-00001.root --mc --eventcontent RAWSIM --datatier GEN --conditions 106X_upgrade2018_realistic_v4 --beamspot Realistic25ns13TeVEarly2018Collision --step LHE,GEN --geometry DB:Extended --era Run2_2018 --no_exec --python_filename run_crab_UL_LHEGEN.py
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/tt012j_5f_Vcb_NLO_FXFX.py nevts:1'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:TOP-RunIISummer20UL18wmLHEGEN-00001.root'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('root://eosuser.cern.ch//eos/user/s/shin/Gridpacks/tt012j_5f_Vcb_NLO_FXFX_slc6_amd64_gcc700_CMSSW_10_2_24_patch1_tarball.tar.xz'),
